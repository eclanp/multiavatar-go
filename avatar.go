...
func init() {
	...
	sp[1] = map[string]string{
		...
		"mouth": "<path d=\"m100.35 143.85a7.67 7.67 0 0 0 7.58 7.7v0a7.66 7.66 0 0 0 7.57-7.7 7.66 7.66 0 0 0 7.57 7.7v0a7.67 7.67 0 0 0 7.58-7.7\" style=\"fill:none;" + str + "6.3998px;stroke:#333;\"/>",
		"eyes":  "<path d=\"m78.73 111a10.9 10.9 0 0 1 15.19 0m43.16 0a10.9 10.9 0 0 1 15.19 0\" style=\"fill:none;" + str + "6.1999px;stroke:#333;\"/><path d=\"m79.804 123.74h7.07m57.273 0h7.05\" style=\"fill:none;" + str + "5.9998px;stroke:#b8b8b8;\"/>",
	...
	sp[3] = map[string]string{
		...
		"mouth": "<path d=\"m136.21 147.09a21.77 21.77 0 0 1-40.13 0z\" style=\"fill:#fff;" + str + "3.4999px;stroke:#000;\"/>",
		"eyes":  "<path d=\"m145.39 104.7-11.52 11.2h17.26m-65.52-11.2 11.52 11.2h-17.26\" style=\"fill:none;" + str + "5.4998px;stroke:#000;\"/>",
	...
	sp[4] = map[string]string{
		...
		"eyes":  "<path d=\"m131.64 114.09 7.5801-7.5801 7.5801 7.5801m-62.6 0 7.5801-7.5801 7.5799 7.5801\" style=\"fill:none;" + str + "6.4998px;stroke:#000;\"/>",
	...
	sp[5] = map[string]string{
		...
		"mouth": "<path d=\"m122.83 151.88a10.49 10.489 0 0 1-14.66 0\" style=\"fill:none;" + str + "6.1996px;stroke:#333;\"/>",
	...
	sp[6] = map[string]string{
		...
		"mouth": "<path d=\"m127.84 146.73c-2.24 8.93-6.92 15.08-12.34 15.08s-10.1-6.15-12.34-15.08z\" style=\"fill:#fff;" + str + "2.9999px;stroke:#1a1a1a;\"/>",
		"eyes":  "<path d=\"m129.31 114.14 20-5.37m-47.66 5.37-20-5.37\" style=\"fill:none;" + str + "4.9998px;stroke:#1a1a1a;\"/>",
	...
	sp[7] = map[string]string{
		...
		"mouth": "<polygon points=\"121.61 160.74 109.39 160.74 115.5 171.31\" style=\"fill:#797979;\"/><path d=\"m132.64 144.06a34.42 34.42 0 0 1-34.24 0\" style=\"fill:none;" + str + "5.9998px;stroke:#000;\"/>",
	...
	sp[9] = map[string]string{
		...
		"mouth": "<path d=\"m126.28 149.82c-6.16 2.43-15.52 2.42-21.56 0\" style=\"fill:none;" + str + "5.9998px;stroke:#1c1c1c;\"/>",
	...
	sp[10] = map[string]string{
		...
		"eyes":  "<path d=\"m97.56 107.84a10.63 10.63 0 0 1-15 0.13l-0.13-0.13\" style=\"fill:none;" + str + "6.3px;stroke:#000;\"/><path d=\"m148.59 107.84a10.63 10.63 0 0 1-15 0.13l-0.13-0.13\" style=\"fill:none;" + str + "6.3px;stroke:#000;\"/>",
	...
	sp[13] = map[string]string{
		...
		"eyes":  "<path d=\"m91.72 97.36v11.4m47.56-11.4v11.4\" style=\"fill:none;" + str + "7.9999px;stroke:#333;\"/>",
	...
	sp[14] = map[string]string{
		...
		"eyes":  "<path d=\"m133 108.17h14.17m-63.26 0h14.09m-20.69-8.93a21.31 21.31 0 0 1 27.29 0m21.8 0a21.31 21.31 0 0 1 27.29 0\" style=\"fill:none;" + str + "4.8243px;stroke:#000;\"/>",
	...
	sp[15] = map[string]string{
		...
		"mouth": "<path d=\"m97.06 144.59a20.15 20.15 0 0 0 36.88 4.53z\" style=\"fill:#fff;" + str + "2.9999px;stroke:#000;\"/>",
...
func SvgCode(avatarId string, sansEnv bool, opts *Options) (svg string, err error) {
	...
	for k, v := range p {
		...
		log.Printf("k: %s, %d, %d color: %v", k, v[0], v[1], colors)
		var svgPart string
		if k == "env" {
			svgPart = env
		} else if k == "head" {
	...
	svg = fmt.Sprintf("%s%s%s%s%s%s%s%s", svgStart, final["env"], final["head"], final["clo"], final["top"], final["eyes"], final["mouth"], svgEnd)
	return
}
